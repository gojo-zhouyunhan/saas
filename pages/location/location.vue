  ...
  <view class="page">
    <view class="hero">
      <view class="hero-copy">
        <text class="hero-eyebrow">同城车源</text>
        <text class="hero-title">发现你附近更靠谱的二手车</text>
        <text class="hero-subtitle">优先展示当前定位周边车源，地图选点后可快速切换到目标商圈。</text>
      </view>
    ...
    <view class="section-head">
      ...
      <view class="section-chip">实时更新</view>
    </view>
...
export default {
  ...
  methods: {
    ...
    applyLocatedAddress(res) {
      ...
      this.province = address.province || address.country || ''
      this.city = address.city || address.poiName || '当前位置'
      this.district = address.district || address.street || ''
    },
    useDefaultLocation() {
