    ...
    <view class="nav-bar">
      <view class="nav-content">
        <view class="nav-left">
          ...
          <text class="nav-title">二手车交易平台</text>
        </view>
        <view class="nav-right">
          <text class="nav-link" @click="goToPage('index')">首页</text>
          <text class="nav-link" @click="goToPage('cars')">车辆</text>
          <text class="nav-link" @click="goToPage('features')">服务</text>
          <text class="nav-link" @click="goToPage('contact')">联系</text>
        </view>
      </view>
    </view>
