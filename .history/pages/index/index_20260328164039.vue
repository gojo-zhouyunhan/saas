<template>
  <view class="container">
    ...
    <!-- 后端接口提示 -->
    <view class="api-tip">
      <view class="api-tip-icon-wrapper">
      ...
      <view class="nav-item active">
        <view class="nav-icon-wrapper">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <path d="M6.5 10c0-1.5.5-3 1.5-4 1 0 1.5 1.5 1.5 3 .5 1.5 1.5 3 3 3s2.5-1.5 3-3c0-1.5.5-3 1.5-4 1 1 1.5 2.5 1.5 4 0 4-2.5 6-5 6s-5-2-5-6Z"></path>
            <path d="M6.5 14c0-1.5.5-3 1.5-4"></path>
            <path d="M16.5 10c0-1.5-.5-3-1.5-4"></path>
            <path d="M16.5 14c0-1.5-.5-3-1.5-4"></path>
          </svg>
        </view>
...
<style>
  ...
  .icon-wrapper {
    ...
    box-shadow: 0 0 0 1rpx rgba(255, 255, 255, 0.8);
  }
