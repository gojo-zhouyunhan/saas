      ...
      <view class="nav-top">
        ...
        <view class="nav-center">
          <view class="search-box">
            ...
            <text class="search-placeholder">搜索车辆</text>
          </view>
        </view>
...
<script>
import { makePhoneCallCompat } from '../../utils/platform'
...
export default {
  ...
  methods: {
    ...
    contactUs() {
      console.log('联系我们');
      makePhoneCallCompat('4001234567');
    }
  }
}
</script>
...
.api-tip {
  background-color: var(--c-primary-soft);
  border: 1rpx solid rgba(11, 60, 93, 0.18);
  border-radius: 16rpx;
  padding: 24rpx;
